...
return [
    ...
    'route' => 'sms-admin',
    // SMS.ir Web Service URLdddfff
    'webservice-url' => env('SMSIR-WEBSERVICE-URL','https://ws.sms.ir/'),
    // SMS.ir Api Key
    'api-key' => env('SMSIR-API-KEY','b0f23de9a25f06caa3d64a2a'),
    // SMS.ir Secret Key
    'secret-key' => env('SMSIR-SECRET-KEY','Talash@1398'),
    // Your sms.ir line number
    'line-number' => env('SMSIR-LINE-NUMBER','30004005353535'),
    // ======================================================================
