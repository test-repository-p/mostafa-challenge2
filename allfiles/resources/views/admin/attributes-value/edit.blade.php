    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h4 class="box-title pull-right">ویرایش  مقدار ویژگی</h4>
                {{--<div class="text-left">--}}
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <form action="{{route('attributes-value.update',$attributeValue->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="title" value="{{$attributeValue->title}}" class="form-control" placeholder="عنوان مقدار ویژگی را وارد نمایید... " type="text">
                            </div>
