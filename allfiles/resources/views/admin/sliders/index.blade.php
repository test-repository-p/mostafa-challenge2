...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h4 class="box-title pull-right">لیست اسلایدر ها</h4>
            <div class="text-left">
                <a href="{{route('sliders.create')}}" class="btn btn-app">
...
@foreach($sliders as $slider)
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-warning" href="{{route('sliders.edit',$slider->id)}}">ویرایش</a>
