...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h4 class="box-title pull-right">لیست کاربران </h4>
            <div class="text-left">
...
@foreach($users as $user)
                <tr>
                    ...
                    <td class="text-center">{{\Hekmatinasser\Verta\Verta::instance($user->created_at)->formatDifference()}}</td>
                    <td class="text-center">{{ $user->present()->status }}</td>
                    <td class="text-center">
