...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3>{{$statistics->todayTotalTransactions}}<sup style="font-size: 20px">%</sup></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h3>{{$statistics->totalUserPending}}</h3>
    ...
    <!-- Morris.js charts -->
    <script src="/admin/dist/js/raphael-min.js"></script>
    ...
    <!-- daterangepicker -->
    <script src="/admin/dist/js//moment.min.js"></script>
