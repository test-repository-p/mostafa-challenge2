...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h4 class="box-title pull-right">لیست مطالب</h4>
            <div class="text-left">
        ...
        <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center">تاریخ به روزرسانی</th>
...
@foreach($posts as $post)
                <tr>
                    ...
                    <td class="text-center">{{\Hekmatinasser\Verta\Verta::instance($post->created_at)->formatDifference()}}</td>
                    <td class="text-center">{{\Hekmatinasser\Verta\Verta::instance($post->updated_at)->formatDifference()}}</td>
