    ...
    <section class="content" id="app">
        <div class="box">
            <div class="box-header">
                <h4 class="box-title pull-right">ویرایش مطلب {{$post->title}}</h4>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <form action="{{route('posts.update',$post->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                    ...
                                    <input name="title" class="form-control" placeholder="نام مطلب  را وارد نمایید..." type="text" value="{{$post->title}}">
                                </div>

                                <div class="form-group">
                                    <label for="slug">عنوان مستعار :</label>
                                    <input name="slug" disabled class="form-control" placeholder="نام مستعار را وارد نمایید..." type="text" value="{{$post->slug}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="textAreaDes" name="description" class="form-control">{{$post->descriptin}}</textarea>
                                </div>
                                ...
                                <input value="{{$post->meta_description}}" name="meta_description" class="form-control" placeholder="توضیحات SEO" type="text">
                                </div>

                                <div class="form-group">
                                    <label for="meta_keywords">کلمات کلیدی SEO  را وارد نمایید. :</label>
                                <input value="{{$post->meta_keywords}}" name="meta_keywords" class="form-control" placeholder="کلمات کلیدی SEO" type="text">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <img src="{{$post->photo->path}}">
                                    </div>
                                <input type="hidden" name="checkfile" value="{{$post->photo_id}}">
